...
public class Knight_ol extends Chess_ol {

    public Knight_ol(int id, int chessBoard_x, int chessBoard_y, String imgFilePath, Team team) {
    ...
    protected boolean step(int chessBoard_x, int chessBoard_y, List<Chess_ol> whiteChessList, List<Chess_ol> blackChessList) {
        ...
        if (Math.abs(getChessBoard_x() - chessBoard_x) == 2 && Math.abs(getChessBoard_y() - chessBoard_y) == 1) {
            return true;
        }
        if (Math.abs(getChessBoard_x() - chessBoard_x) == 1 && Math.abs(getChessBoard_y() - chessBoard_y) == 2){
            return true;
        }
        return false;
    }
